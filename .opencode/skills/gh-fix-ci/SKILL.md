---
name: gh-fix-ci
description: Debug failing GitHub Actions checks on PRs with gh: inspect checks, pull logs, summarize root cause, and propose a fix plan before implementation. Use when the user asks to diagnose or fix GitHub PR CI failures.
metadata:
