---
name: lint-on-edit
description: Workflow replicado de .claude/commands/lint-on-edit.md para 'Lint on Edit — Phicube'. Use quando precisar executar esse procedimento no projeto Binance Phicube.
---
