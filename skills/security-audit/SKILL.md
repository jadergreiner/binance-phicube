---
name: security-audit
description: Workflow replicado de .claude/commands/security-audit.md para 'Auditoria de Segurança — Phicube'. Use quando precisar executar esse procedimento no projeto Binance Phicube.
---
