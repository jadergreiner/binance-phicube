...
description: 'Workflow de Spec-Driven Development (SDD) para refinar, especificar e desenvolver itens com rastreabilidade fim a fim. Use quando criar feature, corrigir bug, alterar regra de negócio, refatorar módulo crítico, ou desenvolver com apoio de IA sem ambiguidade.'
argument-hint: 'Item a tratar (ex: "ajuste no signal_engine", "novo endpoint", "bug de ordem sem SL")'
---
